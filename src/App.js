...
const playlist = [{
  ...
  // file: 'https://www.youtube.com/watch?v=go_nJ42a8PE',
  starttime: 0,
  status: true,
  title: "IDLES - Full Performance (Live on KEXP)",
},
{
  default: false,
  endtime: 0,
  ...
  starttime: 0,
  status: true,
  title: "IDLES - Full Performance (Live on KEXP)----2",
},
{
  default: false,
  endtime: 0,
  ...
  starttime: 0,
  status: true,
  title: "IDLES - Full Performance (Live on KEXP)-----3",
}];
function App() {
